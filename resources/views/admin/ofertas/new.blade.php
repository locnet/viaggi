...
@section('content')
    ...
    <div class="page-header">
        <h1 class="text-center lato-300">Crea una nueva oferta</h1>
    </div>
    <div class="col-md-12">
        {!! Form::open(['url' => '/admin/ofertas/guardar', 'files' => 'true']) !!}            
        ...
        <div class="row">
            <div class="form-group{{ $errors->has('texto') ? ' has-error' : '' }}">
                ...
                <div class="col-md-9 col-xs-12">
                    <p> {!! Form::textarea('texto', old('texto'),
        ...
        <div class="row hotelDetails">
            <div class="form-group {{ $errors->has('alojamiento') ? 'has-error' : '' }}">
                ...
                <div class="col-md-3 col-xs-6">
                    {!! Form::text('alojamiento', old('alojamiento'),
                     [ 'class' => 'form-control  admin-form',
                       'id' => 'alojamiento' ]) !!}
            ...
            <div class="form-group {{ $errors->has('hotel_id') ? 'has-error' : '' }}">
                ...
                <div class="col-md-2 col-xs-4">
                    {!! Form::text('hotel_id',old('hotel_id'),
                     [ 'class' => 'form-control  admin-form',
        ...
        <div class="row">
            <div class="form-group {{ $errors->has('precio_agencias') ? 'has-error' : '' }}">
                ...
                <div class="col-md-3 col-xs-4">
                    {!! Form::text('precio_agencias', old('precio_agencias'),
                     [ 'class' => 'form-control  admin-form']) !!}
        ...
        <div class="row">
            <div class="form-group {{ $errors->has('precio_publico') ? 'has-error' : '' }}">
                ...
                <div class="col-md-3 col-xs-4">
                    {!! Form::text('precio_publico', old('precio_publico'),
                     [ 'class' => 'form-control  admin-form']) !!}
