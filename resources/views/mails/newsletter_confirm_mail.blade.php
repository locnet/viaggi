...
<html>
<head>
<title>Newsletter Andalusiando Viaggi</title>
                                ...
                                <td>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            ...
                                            class="padding-copy"> gracias por apuntarte al nuestro boletin
                                        de noticias.</td>
                                        </tr>
                                        <tr>
                                            <td align="left" style="padding: 20px 0 0 0; font-size: 16px;
                                             ...
                                             Queda una ultima cosa por hacer para terminar corectamente el proceso de registro, por favor haz click en el siguiente 
                                             <a href="{{ url('newsletter/confirm/'.$user->email) }}">enlace</a>.                                             
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="left" style="padding: 20px 0 0 0;
	                                            ...
	                                            <p>{{  url('get-confirmation/'.$user->email) }}.</p>
                                            </td>
                                        </tr>
                ...
                <tr>
                    <td align="left" style="font-size: 12px; line-height: 18px;
                     font-family: Helvetica, Arial, sans-serif; color:#666666;">
                        ...
                        <br>
                        <a href="{{ url('borrar/'.$user->token.'/'.$user->email) }}" 
