				...
				<div class="col-md-8 col-md-offset-2 col-xs-12">				
					<div class="panel">
	                    <div class="panel-heading">
	                    	<h2 class="lato-300 text-center blue">Todo empieza con un Hola</h2>
	                    </div>
	                    <div class="panel-body">
	                    	@if ($message === "ok") 
	                    	    <h2 class="lato-300 text-center yellow">¡Gracias!</h2>
	                    	    <h3 class="lato-300 text-center"> Te contestaremos en 
	                    	    el menor tiempo. </h3>
	                    	...
	                    	@elseif ($message === "error")
	                    	    <h2 class="lato-300 text-center yellow">¡Error!</h2>
	                    	    <h3 class="lato-300 text-center">Lo sentimos, por alguna 
	                    	    estraña razon tu mensaje no ha sido entragado. Escribenos directamente 
	                    	    a info@andalusiandoviaggi.com.
	                    	    </h3>
